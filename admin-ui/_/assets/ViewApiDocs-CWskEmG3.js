import{d as lt,E as st,U as nt,S as at,a as tt,z as Q,w as r,u as Z,a3 as j,a2 as N,V as ve,a4 as Ke,t as ot,D as it,N as rt,l as dt,G as d,i as l,K as W,x as a,_,Z as b,s as X,j as m,b as Qe,P as ct,a0 as Y,J as pt}from"./index-P2ZKOI7U.js";import{F as ut}from"./FieldsQueryParam-D50Uy3Bc.js";function Ze(o,s,n){const i=o.slice();return i[6]=s[n],i}function We(o,s,n){const i=o.slice();return i[6]=s[n],i}function Xe(o){let s;return{c(){s=a("p"),s.innerHTML="Requires superuser <code>Authorization:TOKEN</code> header",m(s,"class","txt-hint txt-sm txt-right")},m(n,i){d(n,s,i)},d(n){n&&r(s)}}}function Ye(o,s){let n,i,v;function p(){return s[5](s[6])}return{key:o,first:null,c(){n=a("button"),n.textContent=`${s[6].code} `,m(n,"class","tab-item"),Y(n,"active",s[2]===s[6].code),this.first=n},m(c,f){d(c,n,f),i||(v=pt(n,"click",p),i=!0)},p(c,f){s=c,f&20&&Y(n,"active",s[2]===s[6].code)},d(c){c&&r(n),i=!1,v()}}}function et(o,s){let n,i,v,p;return i=new tt({props:{content:s[6].body}}),{key:o,first:null,c(){n=a("div"),X(i.$$.fragment),v=b(),m(n,"class","tab-item"),Y(n,"active",s[2]===s[6].code),this.first=n},m(c,f){d(c,n,f),W(i,n,null),l(n,v),p=!0},p(c,f){s=c,(!p||f&20)&&Y(n,"active",s[2]===s[6].code)},i(c){p||(N(i.$$.fragment,c),p=!0)},o(c){j(i.$$.fragment,c),p=!1},d(c){c&&r(n),Z(i)}}}function ft(o){var Ve,ze;let s,n,i=o[0].name+"",v,p,c,f,w,C,ee,V=o[0].name+"",te,$e,le,F,se,B,ne,$,z,ye,G,T,we,ae,J=o[0].name+"",oe,Ce,ie,Fe,re,S,de,A,ce,I,pe,R,ue,Re,M,D,fe,De,be,Oe,h,Pe,E,Te,Ee,xe,me,Be,_e,Se,Ae,Ie,he,Me,qe,x,ke,q,ge,O,H,y=[],He=new Map,Le,L,k=[],Ue=new Map,P;F=new at({props:{js:`
